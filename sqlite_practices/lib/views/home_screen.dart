...
import 'package:state_lession/views/shared_preference_information_screen.dart';
import 'package:state_lession/views/sqlite_information_screen.dart';
...
// 5. Hàm Build
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: (){
                    ...
                    saveInformationIntoSharedPreference(avergeMarkStr: averageMarkStr, gradeStr: gradeStr);
                    Information information = Information(id: null, average_mark: averageMarkStr, grade: gradeStr);
                    saveInformationIntoSQLite(information: information);
                  },
              ...
              TextButton(
                  onPressed: (){
                    ...
                    var route = MaterialPageRoute(builder: (context) => SharedPreferenceInformationScreen());
                    Navigator.push(context, route);

                  },
                  child: Text("Data in Local Storage")),
              TextButton(
                  onPressed: (){

                    var route = MaterialPageRoute(builder: (context) => SQLiteInformationScreen());
                    Navigator.push(context, route);

                  },
                  child: Text("Data in SQLite")),
            ],
          ),
  ...
  saveInformationIntoSharedPreference({ required String avergeMarkStr, required String gradeStr }) async {
  final SharedPreferences prefs = await _prefs;
  print("Lưu gía trị vào Shared Preference");
  prefs.setString("average_mark", avergeMarkStr);
  prefs.setString("grade", gradeStr);

  }

  saveInformationIntoSQLite({required Information information}) async{
